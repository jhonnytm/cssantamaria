...
<div class="container">
    <div class="input-group form-group">
        ...
        <div class="col-md-5"><strong><?php echo ($_SESSION['nombre']) ?></strong> </div>
    </div>
    <div class="card card-5">
        <div class="card-body">
            <form name=histclinica method="post" action="../Models/M_hc.php">
                ...
                <div class="input-group forgroup">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="txtNrodoc" class="form-control" placeholder="Nro de documento" required>
                    </div>
                    <div class="col-md-3">
                        <label>Nro de HC :</label>
                    </div>
                    <div class="col-md-3">
                        <input type="text" name="txthc" id="txthc" class="form-control" placeholder="Nro de HC">
                    </div>
                </div>
                <hr>
                <div class="input-group forgroup">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="txtapepat" class="form-control" placeholder="Apellido Paterno" required>
                    </div>
                    <div class="col-md-3">
                        <label>Apellido materno :</label>
                        <input type="text" name="txtapemat" class="form-control" placeholder="Apellido Materno" required>
                    </div>
                    <div class="col-md-6">
                        <label>Nombres :</label>
                ...
                <div class="input-group forgroup">
                    <div class="col-md-3">
                        ...
                        <input type="date" name="txtfechanac" id="txtfechanac" value="<?php echo date('2000-01-01') ?>" class="form-control" placeholder="Fecha de Nac." required>
                    </div>
                    <div class="col-md-3">
                        <label>Género:</label>
                        <select class="custom-select mr-sm-2 form-control" name="cbogenero" id="cbogenero">
                            <option selected value=0>Género</option>
                    ...
                    <div class="col-md-3">
                        <label>Celular:</label>
                        <input type="text" name="txtcelular" class="form-control" minlength="9" maxlength="9" placeholder="Celular" required>
                    </div>
                </div>
                ...
                <!--<div class="col-md-3">
                        ...
                        <select class="custom-select mr-sm-2 form-control" name="cboestadocivil" id="cboestadocivil">
                ...
                <div class="input-group forgroup">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="txttelefono" class="form-control" minlength="7" maxlength="9" placeholder="Teléfono" required>
                    </div>
                    <div class="col-md-3">
                        <label>Celular:</label>
                        <input type="text" name="txtcelular" class="form-control" minlength="9" maxlength="9" placeholder="Celular" required>
                ...
                <div class="input-group forgroup">
                    ...
                    <div class="col-md-2">
                        <input type=submit name="registrar" class="btn btn-outline-primary" value="Registrar Paciente">
