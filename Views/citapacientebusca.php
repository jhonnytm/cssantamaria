...
<div class="container">
    ...
    <div class="card card-5">
        <div class="card-body">
            ...
            <form name=HC method="post" action="citapacienteprevia.php">
                <div class="input-group form-group ">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <input type="hidden" name="txtdni" class="form-control" placeholder="Número de Documento">
                    </div>
                    <div class="col-md-2">
                        <button type=submit name="buscar" class="btn btn-outline-info">Buscar</button>
