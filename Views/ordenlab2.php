...
<div class="container">
    <?php
    $sql = "SELECT Nro_orden, NroOrdenLab, FechaEmision, FechaTermino, Nro_HC, NroDoc, Paciente, Nombres_Prof, Estado, FechaCita FROM ordenhistprof where Estado='FINALIZADO' order by Nro_orden desc limit 25";
    ...
    if (isset($_POST['buscar'])) {
        ...
        $sql = " SELECT Nro_orden, NroOrdenLab, FechaEmision, FechaTermino, Nro_HC, Nrodoc, Paciente, Nombres_Prof, Estado, FechaCita FROM ordenhistprof " . $condicion . " order by Nro_orden desc limit 25";
    }
        ...
        <div class="card-body">
            <form name=histclinica method="post" action="ordenlab.php">
                <div class="input-group forgroup">
                    <div class="col-md-1">
                        <a href="ordenlabnew.php" class="btn btn-outline-primary">Nuevo</a>
                    </div>
                    <div class="col-md-11">
                    </div>
                </div>
