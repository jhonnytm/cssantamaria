...
if ((isset($ordenlab))) {
    ...
    $pdf->Ln(2);
    //$pdf->line(10, 32, 145, 32);
    //$pdf->line(10, 32, 10, 55);
    $pdf->setY(30);
    ...
    $pdf->SetFont('Arial', 'I', 8);
    $pdf->Cell(20, 4, utf8_decode('Nro de Orden :'), 0, 0, 'L', 1);
    $pdf->SetFont('Arial', 'B', 8);
    $pdf->Cell(40, 4, $nroordenlab, 0, 1, 'L', 1);
    $pdf->SetFont('Arial', 'I', 8);
    ...
    //$pdf->line(10, 55, 145, 55);
    //$pdf->line(145, 32, 145, 55);
    $pdf->Ln(5);
    ...
    //$pdf->Cell(40, 5, utf8_decode('MÉTODO '), 0, 1, 'C', 1);
    $pdf->Ln(5);
    ...
    foreach ($registro as $row) :
        ...
        foreach ($registro2 as $reg) :
            $pdf->Cell(30, 4, utf8_decode($reg['Desc_examen']), 0, 0, 'L', 1);
            $pdf->Cell(70, 4, $reg['Resultado_uno']/*.' '.$reg['Unidad_med']*/, 0, 0, 'C', 1);
